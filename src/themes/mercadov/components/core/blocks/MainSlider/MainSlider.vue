...
export default {
  ...
  mixins: [MainSlider],
  created () {
    this.updateSliderData(Object.assign(sliderData, {
      slides: sliderData.slides.map(d => Object.assign(d, {
        button_text: i18n.t(d.button_text),
        title: i18n.t(d.title),
        subtitle: i18n.t(d.subtitle)
      }))
    }))
  }
}
